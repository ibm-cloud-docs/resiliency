...
![Placement Groups.](images/placement_groups.svg){: caption="Placement group algorithms " caption-side="bottom"}
...
![Autoscale.](images/autoscale-compute.svg){: caption="Auto scale Compute adds virtual servers based on load" caption-side="bottom"}
...
![Autoscale.](images/autoscale-cloud-load-balancer.svg){: caption="Auto scale Cloud Load Balancer distributes load to Auto scaled virtual servers" caption-side="bottom"}
...
![Single-zone deployment.](images/single-tier.svg){: caption="Deploying in single zone" caption-side="bottom"}
...
![Multiple-zone deployment.](images/multi-zone-cis.svg){: caption="Deploying in multiple zones with IBM Cloud Internet Services and IBM Cloud Load Balancer" caption-side="bottom"}
...
![Multiple-zone deployment.](images/multi-zone-lb.svg){: caption="Deploying in multiple zones with {{site.data.keyword.Bluemix_notm}} {{site.data.keyword.loadbalancer_short}} " caption-side="bottom"}
