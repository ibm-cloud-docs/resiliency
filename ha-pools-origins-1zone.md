...
![Deploying server pools and origins in a single MZR.](images/ha-pools-origins-1zone.svg){: caption="Deploying server pools and origins in a single MZR" caption-side="bottom"}
